...
class TenderEmailComposer {
    ...
    private val priceFormat = NumberFormat.getNumberInstance(ruLocale).apply {
        maximumFractionDigits = 2
        minimumFractionDigits = 0
    }

    fun compose(subscription: Subscription, tenders: List<Tender>): EmailMessage {
    ...
    private fun buildHtml(label: String, tenders: List<Tender>): String = buildString {
    ...
    private fun formatPrice(price: BigDecimal, currency: String): String {
